...
[![R build
status](https://github.com/etc5523-2020/r-package-assessment-AntiRosa/workflows/R-CMD-check/badge.svg)](https://github.com/etc5523-2020/r-package-assessment-AntiRosa/actions)
<!-- badges: end -->

The goal of covda is to Analyze Cases With Countries In Cov19

## Installation

You can install the released version of covda from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("covda")
```
